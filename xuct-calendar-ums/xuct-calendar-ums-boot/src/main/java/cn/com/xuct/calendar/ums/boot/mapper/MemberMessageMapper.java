...
public interface MemberMessageMapper extends BaseMapper<MemberMessage> {
     ...
     * @return
     */
    List<MemberMessage> pages(@Param("memberId") Long memberId, @Param("page") Integer page, @Param("limit") Integer limit, @Param("status") Integer status, @Param("sort") Integer sort);
}