 ...
 * @date 2020/6/9
 */
public final class DvaSentinelFeign {

	private DvaSentinelFeign() {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new DvaSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new DvaSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new DvaSentinelInvocationHandler(target, dispatch);
				}
