...
package cn.com.xuct.calendar.common.http.sentinel.ext;
 ...
 */
@Slf4j
public class DvaSentinelInvocationHandler implements InvocationHandler {
	...
	DvaSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			DvaSentinelInvocationHandler other = (DvaSentinelInvocationHandler) obj;
